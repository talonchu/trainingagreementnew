    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tPreview = '<div class="file-preview {class}">\n' +
                ...
                '    </div>\n' +
                '</div>';
            tClose = '<div style="display: none" class="close fileinput-remove">&times;</div>\n';
            ...
            //noinspection HtmlUnknownAttribute
            tBtnLink = '<a style="display: none" id="submitForm" href="{href}" tabindex="500" title="{title}" class="{css}" {status}>{icon} {label}</a>';
            //noinspection HtmlUnknownAttribute
